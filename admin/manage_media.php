...
defined('BASE_PATH') OR exit('No direct script access allowed');
	...
	$sql="SELECT * FROM $db->TB_media $WHERE";
...
?>
						<h2 class="title <?php $utilityObj->title_color(); ?>"><i aria-hidden="true" class="fa fa-database"></i> Manage Medias</h2>
