...
defined('BASE_PATH') OR exit('No direct script access allowed');
	...
	if(isset($_POST['search'])) {
		if(isset($_POST['spage_id']) && $_POST['spage_id']!='') {
			$WHERE_ARRAY[].="a.page_id = ".$_POST['spage_id'];
		}
	...
	$sql="SELECT a.*, b.title FROM $db->TB_page_accordion a LEFT JOIN $db->TB_page b ON a.page_id=b.page_id $WHERE GROUP BY a.page_id";
                                ...
                                <tr>
                                    <td>
                        				<form method="post" action="manage_page.php">
                                        	<input type="text" name="spage_id" placeholder="Page Title:" />
...
?>
                            <tr class="<?php if($i%2==0)echo "even";else echo "no"; ?>">
								...
								<td>
                                	<span class="desktop"><a href="accordion.php?page=<?php echo $page_id; ?>" class="edit"><i aria-hidden="true" class="fa fa-pencil"></i> Edit</a></span>
									<span class="mobile"><a href="accordion.php?page=<?php echo $page_id; ?>" class="edit"><i aria-hidden="true" class="fa fa-pencil"></i></a></span>
                                </td>
                            </tr>
<?php
			$i++;
