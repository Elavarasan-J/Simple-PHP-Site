...
$browserfolder = ltrim($browserfolder["dirname"], '/js/');
...
$username = "myrtle"; $password = '1efaedb3261f566f730198563ae0ea89';

    $useruploadfolder = "arbm/admin/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "arbm/admin/ckeditor/plugins/imageuploader/uploads";
        

    $useruploadfolder = "myrtle\assets\media_library";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "myrtle\assets\media_library";
