...
defined('BASE_PATH') OR exit('No direct script access allowed');
	...
	$sql="SELECT * FROM $db->TB_project $WHERE ORDER BY from_date ASC, to_date DESC";
...
?>
						<h2 class="title <?php $utilityObj->title_color(); ?>"><i aria-hidden="true" class="fa fa-database"></i> Manage Projects</h2>
                        
                        <div class="top-bg">
                            <table cellspacing="0" cellpadding="0" class="filter manage" style="margin-top:0; width:100%">
                                <tr>
                                    <td>
                        				<form method="post" action="manage_project.php">
